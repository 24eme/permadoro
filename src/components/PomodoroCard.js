...
const pomodoroPeriods = {
  pomodoro: { title: "Concentration", icon: "🍅", notification: "On se concentre sur sa tâche pendant 25 minutes, aucune distraction !", duration: pomodoroMinutes * 1000 * 60, color: '#dc3545'},
